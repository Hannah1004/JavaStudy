...
public class E05_BufferedStream {
	...
	public static void main(String[] args) {
		...
		// byte 방식은 글자가 아닌 모든 것들을 전송할 때 사용한다. (InputStrea, OutputStrem)
		try {
			BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream("files/d.txt"), 2048);
